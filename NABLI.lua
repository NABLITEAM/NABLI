...
SUDO = SUDO
sudo_users = {SUDO,1391769117,1635645042,1466244479}   
print([[
> CH › @Dev_NB
> CH › @Source_NB
~> DEVELOPER › @BB1_BB
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/NABLITEAM/Files_NABLI/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNABLIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "Dev_NB")
...
local NABLI_Msg = ''  
if msgs < 100 then 
NABLI_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
NABLI_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
NABLI_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
NABLI_Msg = 'متفاعل' 
elseif msgs < 1200 then 
NABLI_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
NABLI_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
NABLI_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
NABLI_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
NABLI_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
NABLI_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
NABLI_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
NABLI_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
NABLI_Msg = 'رب التفاعل'  
end 
return NABLI_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@BB1_BB")  
...
--------------------------------------------------------------------------------------------------------------
function SourceNABLI(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
SourceNABLIr = '*❦↫اهلا عزيزي*\n*❦↫انا بوت اسمي '..Namot..'*\n*❦↫اختصاصي حمايه الكروبات*\n*❦↫من تكرار والسبام والتوجيه والخ…*\n*❦↫لتفعيلي اتبع الاخطوات…↓*\n*❦↫اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n❦↫[قناة سورس البوت](http://t.me/Dev_NB)'
end
send(msg.chat_id_, msg.id_, SourceNABLIr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevNABLIW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevNABLIW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,NABLI_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ❦' and DevNABLIW(msg) then  
...
if text == 'تعطيل التواصل ❦' and DevNABLIW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❦' and DevNABLIW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❦' and DevNABLIW(msg) then  
...
if text == 'ضع كليشه ستارت ❦' and DevNABLIW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❦↫ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ❦' and DevNABLIW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❦↫تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ❦' and DevNABLIW(msg) then 
...
if text == 'تحديث السورس ❦' and DevNABLIW(msg) then 
os.execute('rm -rf NABLI.lua')
os.execute('wget https://raw.githubusercontent.com/NABLITEAM/NABLI/main/NABLI.lua')
send(msg.chat_id_, msg.id_,' *❦↫تم تحديث السورس* \n*❦↫لديك اخر اصدار لسورس روليكس*\n*❦↫الاصدار » { 2.8v}*')
dofile('NABLI.lua')  
end
if text == 'الاصدار ❦' and DevNABLIW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *❦↫اصدار سورس روليكس* \n*❦↫الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ❦' and DevNABLIW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❦↫[تحديثات البوت](t.me/Source_NB) \n❦↫[قناه السورس](t.me/Dev_NB)')
end
if text == "ضع اسم للبوت ❦" and DevNABLIW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❦↫ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ❦' and DevNABLIW(msg) then 
...
if text == 'المشتركين ❦' and DevNABLIW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❦↫المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❦' and DevNABLIW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❦↫الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❦") and DevNABLIW(msg) then
...
if text == ("قائمه العام ❦") and DevNABLIW(msg) then
...
if text == ("قائمه الكتم العام ❦") and DevNABLIW(msg) then
...
if text=="اذاعه خاص ❦" and msg.reply_to_message_id_ == 0 and DevNABLIW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❦↫ارسل الان اذاعتك؟* \n*❦↫للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ❦" and msg.reply_to_message_id_ == 0 and DevNABLIW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❦↫ارسل الان اذاعتك؟* \n*❦↫للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ❦" and msg.reply_to_message_id_ == 0 and DevNABLIW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❦↫ارسل الان اذاعتك؟* \n*❦↫للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ❦" and msg.reply_to_message_id_ == 0  and DevNABLIW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❦↫ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ❦" and msg.reply_to_message_id_ == 0  and DevNABLIW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❦↫ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❦' and DevNABLIW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❦" and DevNABLIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❦" and DevNABLIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*❦↫عدد الكروبات الان » { '..#group..' }'..NABLIk..''..NABLI..'*\n*❦↫الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevNABLIW(msg) then
...
usertext = '*\n ❦↫العضو »* ['..result.title_..'](t.me/'..(username or 'Dev_NB')..')'
status  = '\n *❦↫تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevNABLIW(msg) then
...
usertext = '\n *❦↫العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Dev_NB')..')'
status  = '\n*❦↫تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevNABLIW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevNABLIW(msg) then
...
local NABLI1_Msg = database:get(bot_id.."NABLI1:Add:Filter:Rp2"..text..msg.chat_id_)   
if NABLI1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❦↫العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Dev_NB')..') \n ❦↫'..NABLI1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if NABLI_Msg and not Special(msg) then  
local NABLI_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if NABLI_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❦↫العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❦↫["..NABLI_Msg.."] \n")
else
send(msg.chat_id_,0," *❦↫العضو :* {["..data.first_name_.."](T.ME/Dev_NB)}\n❦↫["..NABLI_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *❦↫عذرا »* {["..data.first_name_.."](T.ME/Dev_NB)}\n*❦↫عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevNABLIW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevNABLIW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevNABLIW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❦↫حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevNABLIW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❦↫حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ❦" and DevNABLIW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❦↫تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❦$") and DevNABLIW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❦↫حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❦" and DevNABLIW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❦" and DevNABLIW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❦↫تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ❦" and DevNABLIW(msg) then  
...
database:sadd(bot_id.."NABLI:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."NABLI:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_NABLI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_NABLI then 
names_NABLI = database:smembers(bot_id.."NABLI:blocname"..msg.chat_id_) or ""
if names_NABLI and names_NABLI[1] then 
for i=1,#names_NABLI do 
if name_NABLI:match("(.*)("..names_NABLI[i]..")(.*)") then 
...
database:set(bot_id.."NABLI:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."NABLI:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."NABLI:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."NABLI:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."NABLI:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_NABLIa_new(NABLI1,NABLI2)
if NABLI2 and NABLI2.first_name_ then 
if NABLI2.first_name_:match("(.*)"..database:get(bot_id.."NABLI:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."NABLI:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local NABLI_nnn = database:get(bot_id.."NABLI:nump"..msg.chat_id_) or 5
local NABLI_nnn2 = database:get(bot_id.."NABLI:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(NABLI_nnn2) == tonumber(NABLI_nnn) or tonumber(NABLI_nnn2) > tonumber(NABLI_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."NABLI:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❦↫عزيزي >>["..NABLI2.username_.."](https://t.me/"..(NABLI2.username_ or "Dev_NB")..")\n❦↫عليك وضع التوحيد ⪼ {"..database:get(bot_id.."NABLI:teh"..msg.chat_id_).."} بجانب اسمك\n❦↫عدد المحاولات المتبقيه {"..(tonumber(NABLI_nnn) - tonumber(NABLI_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_NABLIa_new)
end
end
...
local NABLIChengName = database:get(bot_id.."NABLI:Cheng:Name"..data.id_)
if not data.first_name_ then 
if NABLIChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..NABLIChengName..']')
database:del(bot_id.."NABLI:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if NABLIChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."NABLI:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local NABLIChengUserName = database:get(bot_id.."NABLI:Cheng:UserName"..data.id_)
if not data.username_ then 
if NABLIChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..NABLIChengUserName..']')
database:del(bot_id.."NABLI:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if NABLIChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."NABLI:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local NABLIChengPhoto = database:get(bot_id.."NABLI:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if NABLIChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."NABLI:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if NABLIChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."NABLI:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴏʟᴇх\n\n[❦  ʀᴏʟᴇх ᴄʜᴀɴɴᴇʟ](http://t.me/Source_NB)\n\n[❦  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Dev_NB)\n\n[❦  ʀᴏʟᴇх ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/BB1_BB)\n\n[❦  ʙᴏᴛ ʀᴏʟᴇх](http://t.me/BB1_BBbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❦ sᴏᴜʀᴄʀ ʀᴏʟᴇх',url="t.me/Dev_NB/839"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dev_NB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevNABLIW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *❦↫بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Dev_NB')..') \n*❦↫تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❦↫بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Dev_NB')..') \n*❦↫تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevNABLIW(msg) then
dofile('NABLI.lua')  
send(msg.chat_id_, msg.id_, ' *❦↫تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevNABLIW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevNABLIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if NABLISudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevNABLIW(msg) then
...
if NABLISudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❦↫لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevNABLIW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevNABLIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevNABLIW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevNABLIW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevNABLIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevNABLIW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevNABLIW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevNABLIW(msg) then
...
if text == 'الملفات' and DevNABLIW(msg) then
...
if DevNABLIW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/NABLITEAM/Files_NABLI/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *❦↫اهلا بك في متجر ملفات روليكس*\n*❦↫ملفات السورس ↓*\n*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*\n *❦↫علامة تعني { ✓ } ملف مفعل*\n *❦↫علامة تعني { ✘ } ملف معطل*\n *❦↫قناة سورس روليكس ↓*\n".." *❦↫*[اضغط هنا لدخول](t.me/Dev_NB) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevNABLIW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/NABLITEAM/Files_NABLI/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevNABLIW(msg) then
...
if text == "مسح الملفات" and DevNABLIW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *❦↫تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevNABLIW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevNABLIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "Dev_NB")
...
function Function_NABLI(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_NABLI, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_NABLI, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❦↫لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Dev_NB')..')'
status  = '\n*❦↫تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *❦↫العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❦↫العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Dev_NB')..')'
...
database:set(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❦↫ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."NABLI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."NABLI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❦↫تم منع الكلمه مع التحذير*")  
database:del(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."NABLI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."NABLI1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."NABLI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *❦↫ارسل الكلمه الان*")  
database:set(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NABLI1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."NABLI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."NABLI1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."NABLI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NABLI1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."NABLI1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *❦↫قائمة المنع* \n*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local NABLI_Msg = database:get(bot_id.."NABLI1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..NABLI_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevNABLIW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❦↫تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevNABLIW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *❦↫العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'Dev_NB')..')'..'\n*❦↫تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevNABLIW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevNABLIW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..NABLI_Msg[math.random(#NABLI_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevNABLIW(msg) then 
...
if NABLISudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevNABLIW(msg) then 
...
if text == ("ردود المطور") and DevNABLIW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❦↫قائمة ردود المطور \n*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevNABLIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevNABLIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevNABLIW(msg) then   
...
if text == 'تعطيل المغادره' and DevNABLIW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*❦↫العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NABLI')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Dev_NB')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
NABLIdx(msg.chat_id_, msg.id_, ' *❦↫ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❦↫عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❦↫عدد المحظورين » ( '..data.kicked_count_..' )*\n*❦↫عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevNABLIW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ❦∫ٴ*•━━━━━━ 𝙍𝙤𝙡𝙚𝙭 ━━━━━━━•*ٴ❦∫○ٴ\n❦↫[𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭](t.me/Dev_NB) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙤𝙪𝙧𝘾𝙚 𝙍𝙤𝙡𝙚𝙭.',url="t.me/Source_NB"}},
}
local msg_id = msg.id_/2097152/0.5
...
NABLI = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(NABLI)
...
--------------------------------------------------------------------------------------------------------------
SourceNABLI(data.message_,data)
...
------------------------------------------------------------------------
local NABLIAbot = database:get(bot_id.."NABLI1:Add:Filter:Rp2"..text..result.chat_id_)   
if NABLIAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❦↫العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❦↫["..NABLIAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local NABLI1_Msg = database:get(bot_id.."NABLI1:Add:Filter:Rp2"..text..result.chat_id_)   
if NABLI1_Msg then
send(msg.chat_id_, msg.id_," ❦↫"..NABLI1_Msg)
